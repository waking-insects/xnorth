<?php
namespace validate;
use validate\exception\Exception;
use validate\Config;
class Request
{
    /**
     ...
     * @access public
     * @return string
     *  $_GET['var_pathinfo'] =>'var_pathinfo'           => 's',
     */
    public function pathinfo()
    {
        if (is_null($this->pathinfo)) {
            ...
            $patinfo_fetch= ['ORIG_PATH_INFO', 'REDIRECT_PATH_INFO', 'REDIRECT_URL'];
            // 分析PATHINFO信息
            if (!isset($_SERVER['PATH_INFO'])) {
                //  foreach (Config::get('pathinfo_fetch') as $type) {
                foreach ($patinfo_fetch as $type) {
    ...
    public function isAjax($ajax = false)
    {
        ...
        if (true === $ajax) {
            ...
            $result           = $this->param('_ajax') ? true : $result;
            $this->mergeParam = false;
            return $result;
        }
    }
    ...
    public function isPjax($pjax = false)
    {
        ...
        if (true === $pjax) {
            ...
            $result           = $this->param('_pjax') ? true : $result;
            $this->mergeParam = false;
            return $result;
        }
    }
